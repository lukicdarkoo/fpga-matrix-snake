...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\materija\RA117-2013\RGB_LED
  logical library name                       : led_map_peripheral_v1_00_a
  top name                                   : led_map_peripheral
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/led_map_peripheral.vhd
...
- XPS interface file(s)
  ...
  data/led_map_peripheral_v2_1_0.mpd
  ...
  data/led_map_peripheral_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/led_map_peripheral.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/led_map_peripheral_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/led_map_peripheral_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/led_map_peripheral_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\materija\RA117-2013\RGB_LED\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
